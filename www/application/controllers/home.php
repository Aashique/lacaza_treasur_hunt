...
class Home extends CI_Controller {
	...
	public function login() {
		...
		if ($result['is_true']) {
			...
			log_message('error', 'is_true is false');
			//redirect to Facebook to authenticate
			$redirectHelper = $this->facebookapi->getRedirectLoginHelper();
			$permissions  = ['email'];
			$loginUrl = $redirectHelper->getLoginUrl(/** callback **/ base_url().'login', $permissions);
			//redirect($this->facebookapi->getLoginURL($this->config->item('facebook_login_parameters'), 'location'));
